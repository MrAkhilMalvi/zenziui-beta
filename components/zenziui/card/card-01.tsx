...
const defaultProps: Card01Props = {
    author: {
        name: "Akhil Malviya",
        username: "akhil_malviya",
        avatar: "https://ferf1mheo22r9ira.public.blob.vercel-storage.com/avatar-04-uuYHWIRvVPi01gEt6NwnGyjqLeeZhz.png",
        timeAgo: "2h ago",
    },
    content: {
        text: "Just launched ZenZi UI! Check out the documentation and let me know what you think 🎨",
        link: {
            title: "ZenZi UI Documentation",
            description: "A comprehensive guide to ZenZi UI",
